...
f_exp=array([1581.2e-12, 1209.1e-12, 978.1e-12, 863.2e-12, 795.4e-12, 592.4e-12, 491e-12, 125e-12,  166e-12, 230e-12, 283e-12 ])
V_exp=array([28., 8., 2.8, 0.8, 0.28, 0.028, 0.0028, 0.01e-6, 0.1e-6, 1e-6, 10e-6])
...
plot(V_exp, f_exp/1e-12, 'o')
plot(x_log, F(p1, x_log)/1e-12)
xscale('log')
xlabel('v [m/s]')
ylabel('F [pN]')
legend( ('Optymalizacja', 'Par. Schultena', 'Z AFM'), loc=2 )
...
f=f1
p2=fmin(err, p, ftol=1e-1, maxiter=1000000, maxfun=1000000)
print 'Optymalizacjia z pracy', p2
