...
plot(V_exp, f_exp/1e-12, 'xr', markersize=18, mew=3)
plot(V, f/1e-12, '+g', markersize=18, mew=3)

xscale('log')
xlabel('v [m/s]')
ylabel('F [pN]')
legend( ('Parametry z dopasowania', 'Parametry Schultena', 'Wyniki z AFM', 'Wyniki z symulacji'), loc=2 )
